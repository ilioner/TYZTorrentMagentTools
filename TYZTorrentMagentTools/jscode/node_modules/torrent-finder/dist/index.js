...
exports['default'] = {
  Archive: _archive2['default'], Dmhy: _dmhy2['default'], Extra: _extra2['default'], Kickass: _kickass2['default'], Nyaa: _nyaa2['default'], Popgo: _popgo2['default'], Piratebay: _piratebay2['default']
};
