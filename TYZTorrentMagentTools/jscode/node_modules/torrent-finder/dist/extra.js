...
var Extra = (function (_BaseScraper) {
  ...
  _createClass(Extra, [{
    ...
    value: function list(page, callback) {
      ...
      return this.requestAndParse(url, createBodyParser(extractList), callback);
    }
  }, {
    key: "search",
    value: function search(terms, callback) {
      ...
      return this.requestAndParse(url, createBodyParser(extractSearch), callback);
    }
  }]);
